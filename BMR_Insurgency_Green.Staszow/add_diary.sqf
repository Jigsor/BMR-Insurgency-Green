...
_info = _info +"
	...
	<br/>
	<br/>Moded support for gas masks include masks from Hidden Identity Pack v2, Identity Pack v3, FFAA, NATO SF and Russian Spetsnaz Weapons, FM-12 strapless from AVON FM12 Respirator Pack and IFA3's US Pilot's Helmet (O2 Mask + Glasses Down).
	<br/>
