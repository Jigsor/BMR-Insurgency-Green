class Params
{
	...
	"NATO - Requirements :: None",
	"NATO and FIA - Requirements :: None",
	...
	"IFA3/FOW - Falscirmjagers - Requirements :: @CBA_A3;@CUP_Terrains_Core;@IFA3_AIO_LITE;@Faces of war",
	"IFA3/FOW - Heer - Requirements :: @CBA_A3;@CUP_Terrains_Core;@IFA3_AIO_LITE;@Faces of war",
	"IFA3/FOW - SS - Requirements :: @CBA_A3;@CUP_Terrains_Core;@IFA3_AIO_LITE;@Faces of war",
	...
	"IFA3 Wehrmacht Winter - Requirements :: @CBA_A3;@CUP_Terrains_Core;@IFA3_AIO_LITE;@Faces of war",
	"IFA3 Wehrmacht - Requirements :: @CBA_A3;@CUP_Terrains_Core;@IFA3_AIO_LITE;@Faces of war"
	};
	default = 19;
	};
	...
	values[]={0,1,2,3,4,5,6,7};
	texts[]={"No","A3 Helis Only","A3 Fixed Wing Only","A3 Helis and A3 Fixed Wing","Moded Helis Only","1 Moded Fixed Wing Only","Moded Helis and Moded Fixed Wing","2 Moded Fixed Wings Only"};
	default = 7;
	};
	...
	texts[]={"Disabled","25 % chance","50 % chance","75 % chance","100 % chance"};
	default = 100;
	};
	class SuicideBombers//27
	{
	...
	class EOS_DAMAGE_MULTIPLIER//32
	{
	...
	class INS_GasGrenadeMod//35
	{
	title = "		Enable Gas Grenades and Masks";
	values[]={0,1};
	texts[]={
	"No",
	"Yes (Yellow Hand and GL smoke grenades. A3 Nato Pilot helmet, full faced Viper helmets, Contact DLC gas masks and or Gas Masks from @hiddenidentitypack, @nato_russian_sf_weapons, @AVON FM12, @FFAA mods and US Pilot's Helmet (O2 Mask + Glasses Down) from IFA3"};
	default = 1;
	};
	class limitPOV//36
	{
