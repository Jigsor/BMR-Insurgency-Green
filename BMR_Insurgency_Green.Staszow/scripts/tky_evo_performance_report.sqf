...
while {true} do
{
	...
	_westcars = {_x isKindOf "Car" && side _x isEqualTo Resistance} count _myentities;
	_eastcars = {_x isKindOf "Car" && side _x isEqualTo west} count _myentities;
	_resistancecars = {_x isKindOf "Car" && side _x isEqualTo east} count _myentities;
	...
	_westair = {_x isKindOf "Air" && side _x isEqualTo Resistance} count _myentities;
	_eastair = {_x isKindOf "Air" && side _x isEqualTo west} count _myentities;
	_resistanceair = {_x isKindOf "Air" && side _x isEqualTo east} count _myentities;
	...
	diag_log format ["FPS %1 WestPlayers %2 EastPlayers %3 Entities %4", floor diag_fps,  playersNumber Resistance, playersNumber West, count _myentities];
	diag_log format ["Occupied Vehicles Resistance=%1 West=%2 East=%3 Civilian=%4", _westcars,_eastcars,_resistancecars,_civiliancars];
	diag_log format ["Dismounted Men Resistance=%1 West=%2 East=%3 Civs=%4", _westmen,_eastmen,_resistancemen, _civmen];
	diag_log format ["Airborne Resistance=%1 West=%2 East=%3", _westair,_eastair,_resistanceair];
	...
	if (!isDedicated) then
	{
		...
		player groupchat format ["FPS %1 WestPlayers %2 EastPlayers %3 Entities %4", floor diag_fps,  playersNumber Resistance, playersNumber West, count _myentities];
		player groupchat format ["Occupied Vehicles Resistance=%1 West=%2 East=%3 Civilian=%4", _westcars,_eastcars,_resistancecars,_civiliancars];
		player groupchat format ["Dismounted Men Resistance=%1 West=%2 East=%3 Civs=%4", _westmen,_eastmen,_resistancemen, _civmen];
		player groupchat format ["Airborne Resistance=%1 West=%2 East=%3", _westair,_eastair,_resistanceair];
