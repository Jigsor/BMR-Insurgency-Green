...
[_tskW,_tasktopicW,_taskdescW,INDEPENDENT,[],"created",_bldgPos] call SHK_Taskmaster_add;
sleep 5;
...
[_tskE,_tasktopicE,_taskdescE,WEST,[],"created",_bldgPos] call SHK_Taskmaster_add;
