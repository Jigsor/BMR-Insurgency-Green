...
{WEST revealMine _x;} foreach _alltskmines;
...
{
	_knownmines = detectedMines INDEPENDENT;
	{INDEPENDENT revealMine _x;} foreach _knownmines;
	...
	{
		if ((side group _x) in [EAST,WEST,CIVILIAN]) then {
