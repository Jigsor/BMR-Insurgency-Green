...
if (!SideMissionCancel) then {
	...
	{_defenderArr pushBack _x} forEach (objective_pos_logic nearEntities ["CAManBase", _defender_rad] select {(side _x isEqualTo Independent) && !(captiveNum _x isEqualTo 1) && (_x isKindOf "Man")});
	sleep 3;
