...
private ["_VehPool","_rnum","_range","_randVeh","_objmkr","_cone","_VarName","_grp","_handle","_type","_obj_leader","_stat_grp","_wp","_tskW","_tasktopicW","_taskdescW","_tskE","_tasktopicE","_taskdescE","_vehicle1","_newPos","_veh1","_vehicle2","_veh2","_vehicle3","_veh3","_vehicle4","_veh4","_handle1","_allVeh","_killconvoy"];
...
[_tskW,_tasktopicW,_taskdescW,INDEPENDENT,[],"created",_newZone] call SHK_Taskmaster_add;
sleep 5;
...
[_tskE,_tasktopicE,_taskdescE,WEST,[],"created",_newZone] call SHK_Taskmaster_add;
...
{
	if ({alive _x} count units sconvoy_grp < 1) exitWith {
