...
[_tskW,_tasktopicW,_taskdescW,INDEPENDENT,[],"created",_towerPos] call SHK_Taskmaster_add;
sleep 5;
...
[_tskE,_tasktopicE,_taskdescE,WEST,[],"created",_towerPos] call SHK_Taskmaster_add;
