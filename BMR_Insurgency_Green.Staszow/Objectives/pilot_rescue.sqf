...
private _basePos = (markerPos "Respawn_Guerrila");
private _pilotType = nil;
private _getpilot = true;

//mod for CUP
if (INS_op_faction in [13,14]) then {
...
//mod for IFA3Lite Green
if (INS_op_faction in [9,10,11,18,19]) then {
	_pilotType = "LIB_US_pilot";
